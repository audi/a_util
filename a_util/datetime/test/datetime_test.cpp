...
TEST(datetime_test, TestTimestampConversion)
{
    ...
    timestamp_t system_timestamp_jd = system_date_time.toTimestamp();
    timestamp_t system_timestamp_ut =
     ...
     *------------------------------------------------------------------------*/
    EXPECT_NEAR((double) system_timestamp_ut, (double) now_ut, 1000);
    ...
    EXPECT_NEAR(system_date_time.getMicrosecond(), now_date_time.getMicrosecond(), 1000);
    ...
    timestamp_t date_jd_timestamp = ut_date.toTimestamp();

    timestamp_t date_ut_timestamp =
