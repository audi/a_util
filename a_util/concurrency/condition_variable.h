/**
 * @file
 * Copyright &copy; 2017 Audi Electronics Venture GmbH. All rights reserved.
 *
 * @copyright
 * @verbatim
...
#include "a_util/concurrency/detail/condition_variable_cxx11.h"
...
using detail::condition_variable;
using detail::cv_status;
