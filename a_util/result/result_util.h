/**
 * @file
 * Utility functions and classes for the tResult class
 *
 * @copyright
 * @verbatim
...
/**
 * @brief Copy all information of an assigned result object to a (formatted) string
 * @param[in] other_result The result instance getting stringified
