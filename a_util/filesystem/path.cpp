...
static const char* BACKWARD_DOUBLE_SLASHES = "\\\\";
static const char* FORWARD_DOUBLE_SLASHES = "//";

// native slash definition
#ifdef WIN32
static const char NATIVE_SLASH = BACKWARD_SLASH;
static const char* NATIVE_DOUBLE_SLASHES = BACKWARD_DOUBLE_SLASHES;
static const Path::PathSeparator NATIVE_SEPARATOR = Path::PS_BackwardSlash;
#else
static const char NATIVE_SLASH = FORWARD_SLASH;
static const char* NATIVE_DOUBLE_SLASHES = FORWARD_DOUBLE_SLASHES;
...
static void NormalizePath(std::string& path)
{
    ...
    if (NATIVE_SEPARATOR == Path::PS_ForwardSlash)
    {
