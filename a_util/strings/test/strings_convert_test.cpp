...
TEST(string_convert_test, TestStringToUInt32)
{
    ...
    // positive tests (char*)
    EXPECT_EQ(1, strings::toUInt32("1"));
    EXPECT_EQ(42, strings::toUInt32("42"));
    EXPECT_EQ(1, strings::toUInt32("+1"));
    EXPECT_EQ(42, strings::toUInt32("+42"));
    EXPECT_EQ(0, strings::toUInt32("+0"));
    EXPECT_EQ(0, strings::toUInt32("-0"));
    ...
    // negative tests
    EXPECT_EQ(0, strings::toUInt32(""));
    EXPECT_EQ(0, strings::toUInt32(nullptr));
    EXPECT_EQ(0, strings::toUInt32("+"));
    EXPECT_EQ(0, strings::toUInt32("-"));
    EXPECT_EQ(0, strings::toUInt32("1.0"));
    EXPECT_EQ(0, strings::toUInt32("-2"));
    EXPECT_EQ(0, strings::toUInt32("4294967296"));
    EXPECT_EQ(0, strings::toUInt32("+4294967296"));
}
