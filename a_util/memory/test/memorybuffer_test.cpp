...
public:
    MemoryBufferTestFixture() :
        _random_alloc_sizes{0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x100, 0x200,
...
protected:
    ...
    const std::array<std::size_t, 16>& allocSizes() const noexcept { return _random_alloc_sizes; }
