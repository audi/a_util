...
static const std::size_t variant_type_sizes[] = {
    0,                     // VT_Empty
    sizeof(bool),          // VT_Bool
...
Variant::Variant() : _impl(new Implementation())
{
    // _impl->reset(); // not needed
}

Variant::Variant(bool value) : _impl(new Implementation())
{
    _impl->reset(value, _impl->_value.bool_val);
}

Variant::Variant(std::int8_t value) : _impl(new Implementation())
{
    _impl->reset(value, _impl->_value.int8_val);
}

Variant::Variant(std::uint8_t value) : _impl(new Implementation())
{
    _impl->reset(value, _impl->_value.uint8_val);
}

Variant::Variant(std::int16_t value) : _impl(new Implementation())
{
    _impl->reset(value, _impl->_value.int16_val);
}

Variant::Variant(std::uint16_t value) : _impl(new Implementation())
{
    _impl->reset(value, _impl->_value.uint16_val);
}

Variant::Variant(std::int32_t value) : _impl(new Implementation())
{
    _impl->reset(value, _impl->_value.int32_val);
}

Variant::Variant(std::uint32_t value) : _impl(new Implementation())
{
    _impl->reset(value, _impl->_value.uint32_val);
}

Variant::Variant(std::int64_t value) : _impl(new Implementation())
{
    _impl->reset(value, _impl->_value.int64_val);
}

Variant::Variant(std::uint64_t value) : _impl(new Implementation())
{
    _impl->reset(value, _impl->_value.uint64_val);
}

Variant::Variant(float value) : _impl(new Implementation())
{
    _impl->reset(value, _impl->_value.float_val);
}

Variant::Variant(double value) : _impl(new Implementation())
{
    _impl->reset(value, _impl->_value.double_val);
}

a_util::variant::Variant::Variant(const char* value) : _impl(new Implementation())
{
    _impl->reset(value);
}

Variant::Variant(const Variant& other_var) : _impl(new Implementation(*other_var._impl))
{
}
...
Variant& Variant::operator=(const Variant& other_var)
{
    if (&other_var != this)
    {
        _impl.reset(new Implementation(*other_var._impl));
    }
    return *this;
}
