...
public:
    ...
    Implementation(DOMElement* self) : _node(), _document(nullptr)
    {
    }
...
DOMElement::DOMElement() : _impl(Implementation(this))
{
}
...
bool operator==(const DOMElement& lhs, const DOMElement& rhs)
{
    ...
    if (!equal && Local::hasEqualAttributesNameAndData(lhs, rhs))
