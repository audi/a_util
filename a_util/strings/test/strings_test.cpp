...
TEST(string_test, TestStringCompare)
{
    ...
    // negative
    EXPECT_TRUE(0 > strings::compare(nullptr, ""));
    EXPECT_TRUE(0 < strings::compare("", nullptr));
    EXPECT_TRUE(0 != strings::compare(nullptr, nullptr));

    EXPECT_TRUE(0 > strings::compare("", "abcdefg", 0, -1));  // 0
    EXPECT_TRUE(0 > strings::compare("", "abcdefg", -5, -1)); // 0
    EXPECT_TRUE(0 > strings::compare("", "abcdefg", -5, 5));
    EXPECT_TRUE(0 > strings::compare("", "abcdefg", 0, 5));

    EXPECT_TRUE(0 > strings::compare("", "abcdefg", 3));  // 0
    EXPECT_TRUE(0 > strings::compare("", "abcdefg", 99)); // 0
    EXPECT_TRUE(0 > strings::compare("", "abcdefg", 0));  // 0
    EXPECT_TRUE(0 > strings::compare("", "abcdefg"));     // 0
    EXPECT_TRUE(0 > strings::compare("", "abcdefg"));     // 0

    EXPECT_TRUE(0 > strings::compareNoCase("", "abcdefg", 0, -1));  // 0
    EXPECT_TRUE(0 > strings::compareNoCase("", "abcdefg", -5, -1)); // 0
    EXPECT_TRUE(0 > strings::compareNoCase("", "abcdefg", -5, 5));
    EXPECT_TRUE(0 > strings::compareNoCase("", "abcdefg", 0, 5));

    EXPECT_TRUE(0 > strings::compareNoCase("", "abcdefg", 3));  // 0
    EXPECT_TRUE(0 > strings::compareNoCase("", "abcdefg", 99)); // 0
    EXPECT_TRUE(0 > strings::compareNoCase("", "abcdefg", 0));  // 0
    EXPECT_TRUE(0 > strings::compareNoCase("", "abcdefg"));     // 0
    EXPECT_TRUE(0 > strings::compareNoCase("", "abcdefg"));     // 0

    EXPECT_TRUE(0 == strings::compare("", "", 0, -1));  // 0
    EXPECT_TRUE(0 == strings::compare("", "", -5, -1)); // 0
    EXPECT_TRUE(0 == strings::compare("", "", -5, 5));
    EXPECT_TRUE(0 == strings::compare("", "", 0, 5));

    EXPECT_TRUE(0 == strings::compare("", "", 3));  // 0
    EXPECT_TRUE(0 == strings::compare("", "", 99)); // 0
    EXPECT_TRUE(0 == strings::compare("", "", 0));  // 0
    EXPECT_TRUE(0 == strings::compare("", ""));     // 0
    EXPECT_TRUE(0 == strings::compare("", ""));     // 0

    EXPECT_TRUE(0 == strings::compareNoCase("", "", 0, -1));  // 0
    EXPECT_TRUE(0 == strings::compareNoCase("", "", -5, -1)); // 0
    EXPECT_TRUE(0 == strings::compareNoCase("", "", -5, 5));
    EXPECT_TRUE(0 == strings::compareNoCase("", "", 0, 5));

    EXPECT_TRUE(0 == strings::compareNoCase("", "", 3));  // 0
    EXPECT_TRUE(0 == strings::compareNoCase("", "", 99)); // 0
    EXPECT_TRUE(0 == strings::compareNoCase("", "", 0));  // 0
    EXPECT_TRUE(0 == strings::compareNoCase("", ""));     // 0
    EXPECT_TRUE(0 == strings::compareNoCase("", ""));     // 0

    // static members
    EXPECT_TRUE(0 == strings::compare("", ""));
    EXPECT_TRUE(0 == strings::compare("", "", 10));
    EXPECT_TRUE(0 == strings::compare("", "", -10));
    EXPECT_TRUE(0 == strings::compare("", ""));
    EXPECT_TRUE(0 == strings::compare("", "", 10));
    EXPECT_TRUE(0 == strings::compare("", "", -10));
    EXPECT_TRUE(0 == strings::compare("a", "a", 10));
    EXPECT_TRUE(0 == strings::compare("a", "a", -10));

    EXPECT_TRUE(0 == strings::compareNoCase("", ""));
    EXPECT_TRUE(0 == strings::compareNoCase("", "", 10));
    EXPECT_TRUE(0 == strings::compareNoCase("", "", -10));
    EXPECT_TRUE(0 == strings::compareNoCase("", ""));
    EXPECT_TRUE(0 == strings::compareNoCase("", "", 10));
    EXPECT_TRUE(0 == strings::compareNoCase("", "", -10));
    EXPECT_TRUE(0 == strings::compareNoCase("a", "a", 10));
    EXPECT_TRUE(0 == strings::compareNoCase("a", "a", -10));

    // positive
    EXPECT_TRUE(0 == strings::compare("abcdefg", "abcdefg", 0, -1)); // 0
    EXPECT_TRUE(0 <= strings::compare("abcdefg", "abcdefg", 3));     // 0
    EXPECT_TRUE(0 == strings::compare("abcdefg", "abcdefg", 99));    // 0
    EXPECT_TRUE(1 == strings::compare("abcdefg", "abc", 5));         // 1
    EXPECT_TRUE(0 == strings::compare("abcdefg", "abcdefg", 0, 2));  // 0
    EXPECT_TRUE(0 == strings::compare("abcdefg", "abcdefg", 3, 2));  // 0
    EXPECT_TRUE(0 == strings::compare("abcdefg", "abcdefg", 99, 2)); // 0
    EXPECT_TRUE(0 < strings::compare("abcdefg", "abc", 2, 2));       // 1
    EXPECT_TRUE(1 == strings::compare("abcdefg", "abc", 5, 2));      // 1

    EXPECT_TRUE(0 > strings::compare("abc", "abcdefg", 5));    // -1
    EXPECT_TRUE(0 > strings::compare("abc", "abcdefg", 2, 2)); // -1
    EXPECT_TRUE(0 > strings::compare("abc", "abcdefg", 5, 2)); // -1

    EXPECT_TRUE(0 == strings::compareNoCase("abcdefg", "ABCDEFG", 0, -1)); // 0
    EXPECT_TRUE(0 == strings::compareNoCase("abcdefg", "ABCDEFG", 3));     // 0
    EXPECT_TRUE(0 == strings::compareNoCase("abcdefg", "ABCDEFG", 99));    // 0
    EXPECT_TRUE(1 == strings::compareNoCase("abcdefg", "ABC", 5));         // 1
    EXPECT_TRUE(0 == strings::compareNoCase("abcdefg", "ABCDEFG", 0, 2));  // 0
    EXPECT_TRUE(0 == strings::compareNoCase("abcdefg", "ABCDEFG", 3, 2));  // 0
    EXPECT_TRUE(0 == strings::compareNoCase("abcdefg", "ABCDEFG", 99, 2)); // 0
    EXPECT_TRUE(0 < strings::compareNoCase("abcdefg", "ABC", 2, 2));       // 1
    EXPECT_TRUE(0 < strings::compareNoCase("abcdefg", "ABC", 5, 2));       // 1

    EXPECT_TRUE(0 > strings::compareNoCase("abc", "ABCDEFG", 5));    // -1
    EXPECT_TRUE(0 > strings::compareNoCase("abc", "ABCDEFG", 2, 2)); // -1
    EXPECT_TRUE(0 > strings::compareNoCase("abc", "ABCDEFG", 5, 2)); // -1
}
...
TEST(string_test, TestStringIsEqual)
{
    ...
    // negative
    EXPECT_FALSE(strings::isEqual("", "abcdefg", 0, -1));  // 0
    EXPECT_FALSE(strings::isEqual("", "abcdefg", -5, -1)); // 0
    EXPECT_FALSE(strings::isEqual("", "abcdefg", -5, 5));
    ...
    EXPECT_TRUE(strings::isEqual("", "", 0, -1));  // 0
    EXPECT_TRUE(strings::isEqual("", "", -5, -1)); // 0
    EXPECT_TRUE(strings::isEqual("", "", -5, 5));
    ...
    // positive
    EXPECT_TRUE(strings::isEqual("abcdefg", "abcdefg", 0, -1)); // 0
    ...
    EXPECT_TRUE(strings::isEqualNoCase("abcdefg", "ABCDEFG", 0, -1)); // 0
