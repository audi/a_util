...
inline bool
    ResultDescriptionTraits<DescriptionType>::isDetailedDescriptionSet(const std::uint64_t value)
{
...
template <typename DescriptionType>
inline ResultDescription<DescriptionType>& ResultDescription<DescriptionType>::
    operator=(const ResultDescription& other)
{
...
template <typename DescriptionType>
inline ResultDescription<DescriptionType>
